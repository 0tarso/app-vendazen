...
export default function CustomModalSelector(props: CustomModalSelectorProps) {
  ...
  return (
    <>
      <ModalSelector
        data={props.data}
        initValue="Selecione um cliente"
        initValueTextStyle={{ textAlign: 'left', fontWeight: 400, fontSize: 18, color: COLORS.GrayFont }}
        onChange={(option) => props.onChange(option.key, option.label)}
        animationType='slide'
        listType='FLATLIST'
        selectStyle={{
          borderWidth: 0,
