...
export default function CustomerDetails() {
  ...
  const { getCustomerById, payments, purchases } = useCustomer()

  const [customer, setCustomer] = useState<CustomerWithPurchasesAndPayments | null>(null)

  const [customerPurchases, setCustomerPurchases] = useState<PurchaseWithCustomer[] | null>(null)
  const [lastPurchases, setLastPurchases] = useState<PurchaseSchema[] | null>(null)

  const [customerPayments, setCustomerPayments] = useState<PaymentWithCustomerName[] | null>(null)
